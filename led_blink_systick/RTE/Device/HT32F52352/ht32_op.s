...
;// <e> Program Checksum
CHECKSUM_OPT    EQU     0
;//   <o0> Writer Checksum: Code
;//   <o1> Writer Checksum: Data
;//   <o2> Writer Checksum: Code+Option
CK_CODE         EQU        0xFFFFFFFF
CK_DATA         EQU        0xFFFFFFFF
CK_CODEOP       EQU        0xFFFFFFFF

                IF      CHECKSUM_OPT <> 0
                AREA    |.ARM.__AT_0x1FF00030|, CODE, READONLY
                DCD   CK_CODE       ; 0x1FF00030
                DCD   CK_DATA       ; 0x1FF00034
                DCD   CK_CODEOP     ; 0x1FF00038
                ENDIF

;// </e>

;// <e> Program user's Flash data into Option Byte
;// <i> Address range: from 0x1FF00050 to 0x1FF003FF/0x1FF002FF (Max 944/432 Bytes)
FLASH_DATA      EQU     0
;// </e>
                IF      FLASH_DATA <> 0
